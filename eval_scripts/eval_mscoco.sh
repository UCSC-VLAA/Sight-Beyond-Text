...
if [ $# -eq 4 ]; then
	...
	python llava/eval/mmoverall/evaluate.py --eval_coco --additional_shots 3 --coco_image_dir_path ${image_dir_path} \
		--coco_annotations_json_path ${test_annot_path} --coco_demo_annotations_json_path ${demo_annot_path} \
