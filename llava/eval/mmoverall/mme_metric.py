...
## exclude 'landmark' and 'artwork' tasks
eval_type_dict = {
    "Perception": ["existence", "count", "position", "color", "posters", "celebrity", "scene", "OCR"],
    "Cognition": ["commonsense_reasoning", "numerical_calculation", "text_translation", "code_reasoning"]
}
                ...
                for img_items in chunk_lines:
                    ...
                    for img_item in img_items:
                        try:
                            ...
                            img_name, question, gt_ans = img_item.split("\t")
                            pred_ans = "other"
...
def get_final_mme_scores(results_dir):
    cal = calculate_metrics()
    return cal.process_result(results_dir)


if __name__ == "__main__":
    mme_test_path = "path/to/mme/testing"
